...
KoshekhBot.prototype._searchForKeywords = function(message) {
	...
	if (message.text.toLowerCase().indexOf('!helpme') > -1) {
		...
		self.postMessageToChannel(channel.name,"I am a helpful cat that hovers four feet off the ground in the mens bathroom of the Night Vale Community Radio station. I will provide a daily inspiring quote from my compatriot, protector, and on-air host Cecil Baldwin.\n I can respond to a few basic commands as well. \n Currently I will respond to !whoareyou, !koshekh, and !repeat.", {as_user:true});
	}
};
